...
js_url: 'https://d37gvrvc0wt4s1.cloudfront.net/js/v1.3/rollbar.umd.min.js'
---
## Installation

To use the JavaScript [rollbar.js](https://github.com/rollbar/rollbar.js) notifier, simply copy-paste the following code 
...
<body>
<button type="button" onclick="throw new Error('RollbarTestError');">Throw RollbarTestError</button>
</body>
</html>
```
